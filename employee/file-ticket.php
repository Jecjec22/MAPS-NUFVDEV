                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <a href = "ticket-history.php"><button class="btn btn-primary">See Supervisor's Feedback</button></a>
                                
                                    <a href = "tickets-pending.php"><button class="btn btn-primary">See Pending Tickets</button></a>
                                </div>
