...
?>
    ...
    <head>
        ...
        <title>MANPOWER ALLOCATION AND PLANNING SYSTEM || View Inprogress Service</title>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $row) { ?>
                                                                <tr <?php echo (strtotime($row->TaskEnddate) < strtotime(date("Y-m-d"))) ? 'style="background-color: #ffcccc;"' : ''; ?>>
                                                                    ...
                                                                    <?php } ?>
                                                                    <td><a href="view-task.php?viewid=<?php echo htmlentities($row->tid); ?>" class="btn btn-primary">View</a></td>
                                                                </tr>
                                                        <?php $cnt = $cnt + 1;
                                                            }
                                                        } ?>
