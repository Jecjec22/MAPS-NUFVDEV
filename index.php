...
<section class = "gradient-background">
  <div class="container pt-4">
    <div class="card" style="border-radius: 0px; box-shadow: 0 4px 20px 1px rgb(0 0 0 / 6%), 0 1px 4px rgb(0 0 0 / 8%);">
      <div class="row g-0">
